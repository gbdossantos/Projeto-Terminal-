    ...
    <>
      ...
      {showExemploBanner && (
        ...
        >
          ...
          >
            Exemplo de lote pré-preenchido. Edite os valores ou{" "}
            <button
      ...
      <div className="border border-border rounded-lg bg-card p-5 space-y-5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <Field label="Rendimento carcaça (%)" value={(form.rendimento_carcaca ?? 0.54) * 100} onChange={(v) => set("rendimento_carcaca", v / 100)} />
          <Field label="Reposição total (R$)" value={form.custo_reposicao_total} onChange={(v) => set("custo_reposicao_total", v)} step={10000} />
        </div>
        ...
        <div className="border-t border-border pt-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <Field label="Instalações" value={form.custo_instalacoes_dia ?? 0} onChange={(v) => set("custo_instalacoes_dia", v)} step={0.1} />
          </div>
        </div>
        ...
        <div className="border-t border-border pt-4">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <Field label="Frete saída (R$)" value={form.custo_frete_saida ?? 0} onChange={(v) => set("custo_frete_saida", v)} step={500} />
      ...
      {r && data && (
        <>
          ...
          <MetricCard label="Participação da dieta" value={fmtPct(r.participacao_dieta_pct ?? 0)} compact />
